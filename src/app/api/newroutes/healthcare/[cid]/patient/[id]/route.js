...
export async function GET(req, {params}) {
  try {
    ...
    `;
    const medicalRecordsResult = await pool.query(medicalRecordsQuery, [id, cid]);
    ...
    `;
    const appointmentsResult = await pool.query(appointmentsQuery, [id, cid]);
    ...
    `;
    const labRequestsResult = await pool.query(labRequestsQuery, [id, cid]);
