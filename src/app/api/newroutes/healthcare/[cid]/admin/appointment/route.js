  ...
  try {
    ...
    const result = await pool.query(
      `SELECT 
          ...
          cn.centername AS center_name       -- Fetch center name from center table
       FROM 
          appointment a
       JOIN 
    ...
    // Respond with the data, including room_name, createdby info, center_name, and patient_dob if present
