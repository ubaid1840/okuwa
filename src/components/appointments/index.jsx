  ...
  useEffect(() => {
    ...
    if (search === "true" && !toast.isActive(toastIdRef.current)) {
      showToastSuccess(
        toast,
        toastIdRef,
        t("appointmentSuccessfullyScheduled"),
        t("appointmentSuccessfullyScheduledSubheading")
      );
    }
  }, []);
        ...
        {data.length == 0 ? (
          ...
          >
            <HStack justify={"space-between"} width={"100%"} p={5}>
              ...
              <div>
                <Link href={`${pathname}/addappointment`}>
